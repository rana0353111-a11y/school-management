...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO students (name, roll_no, class, section, phone, address) 
            VALUES ('$name', '$roll_no', '$class', '$section', '$phone', '$address')";

    if (mysqli_query($conn, $sql)) {
        echo "<script>alert('Student Added!'); window.location='view.php';</script>";
    }
}
?>
<!DOCTYPE html>
